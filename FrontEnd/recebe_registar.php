...
$sql = "INSERT INTO eleitor (nif, pass, email, data_nascimento, estado_voto, data_voto, data_time_out, tipo_voto, sexo)
VALUES ($nif, '$hashed_password', '$email', '$data_nascimento', $estado_voto, '$data_voto', '$data_time_out', $tipo_voto, $sexo )";
